...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p class="text-own">Twoja wizyta dnia: {{ \Carbon\Carbon::parse($visit->date)->format('d.m.Y') }} w godzinach: {{ \Carbon\Carbon::parse($visit->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($visit->end_time)->format('H:i') }} została właśnie anulowna. Jeśli chcesz umówić się na nowy termin odwiedź naszą stronę klikając w przycisk</p>
