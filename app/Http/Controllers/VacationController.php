...
// -----------------------------------
// Generowanie blokad poza godzinami pracy
// -----------------------------------

$dayStart = Carbon::createFromTime(7, 0);
$dayEnd = Carbon::createFromTime(21, 0);
...
while ($currentDate->lte($endDate)) {
    ...
    foreach ($doctors as $doctor) {
        ...
        // Lekarz nie pracuje tego dnia
        if (!isset($workingDays[$doctor->id])) {
